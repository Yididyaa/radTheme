...
if ( ! function_exists( 'bloom_theme_setup' ) ) :
	...
	function bloom_theme_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'bloom' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'bloom_theme_custom_background_args', array(
 ...
 */
function bloom_theme_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'bloom_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'bloom_theme_content_width', 0 );
...
function bloom_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bloom' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bloom' ),
...
add_action( 'widgets_init', 'bloom_theme_widgets_init' );
...
function bloom_theme_scripts() {
	...
	wp_enqueue_script( 'bloom-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'bloom-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'bloom_theme_scripts' );
...
class bloom_navbar extends Walker_Nav_Menu
{
